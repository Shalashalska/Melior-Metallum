...
public class ModBlocks {
    ...
    private static void registerBlocks(){
        vanadiumOre = new BlockMetallum(BlockIds.VANADIUM_ORE_ID, Material.rock, Strings.VANADIUM_ORE_NAME);
        vanadiumBlock = new BlockMetallum(BlockIds.VANADIUM_BLOCK_ID, Material.rock, Strings.VANADIUM_BLOCK_NAME);
        thoriumOre = new BlockMetallum(BlockIds.THORIUM_ORE_ID, Material.rock, Strings.THORIUM_ORE_NAME);
        thoriumBlock = new BlockMetallum(BlockIds.THORIUM_BLOCK_ID, Material.rock, Strings.THORIUM_BLOCK_NAME);
